...
{
    [ApiController]
    [Route("api/eventos/{eventId:guid}/zonas/{zonaId:guid}/asientos")]
    [Produces("application/json")]
    public class AsientosController : ControllerBase
    {
        private readonly IMediator _mediator;
        public AsientosController(IMediator mediator) => _mediator = mediator;
        ...
        public async Task<IActionResult> Crear(Guid eventId, Guid zonaId, [FromBody] CrearAsientoDto dto, CancellationToken ct)
        {
            var result = await _mediator.Send(new CrearAsientoCommand(
                eventId, zonaId, dto.FilaIndex, dto.ColIndex, dto.Label, dto.Estado, dto.Meta
            ), ct);
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        public async Task<IActionResult> ObtenerPorId(Guid eventId, Guid zonaId, Guid asientoId, CancellationToken ct)
        {
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        public async Task<IActionResult> Listar(Guid eventId, Guid zonaId, CancellationToken ct)
        {
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesResponseType(StatusCodes.Status422UnprocessableEntity)]
        public async Task<IActionResult> Actualizar(Guid eventId, Guid zonaId, Guid asientoId, [FromBody] ActualizarAsientoDto dto, CancellationToken ct)
        {
            await _mediator.Send(new ActualizarAsientoCommand(
                eventId, zonaId, asientoId, dto.Label, dto.Estado, dto.Meta
            ), ct);
        ...
        [ProducesResponseType(StatusCodes.Status204NoContent)]
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        public async Task<IActionResult> Eliminar(Guid eventId, Guid zonaId, Guid asientoId, CancellationToken ct)
        {
